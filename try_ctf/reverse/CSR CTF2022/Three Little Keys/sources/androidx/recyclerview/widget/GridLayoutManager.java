...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static abstract class c {
        ...
        public final SparseIntArray f1278a = new SparseIntArray();

        /* renamed from: b  reason: collision with root package name */
        public final SparseIntArray f1279b = new SparseIntArray();
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.M = new a();
        this.N = new Rect();
        P1(RecyclerView.l.S(context, attributeSet, i, i2).f1311b);
    }
    ...
    */
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.l
    public void m0(RecyclerView.r rVar, RecyclerView.w wVar, View view, d dVar) {
        int i;
        int i2;
        int i3;
        boolean z;
    ...
    */
    ...
    public void w1(RecyclerView.r rVar, RecyclerView.w wVar, LinearLayoutManager.a aVar, int i) {
        ...
        if (wVar.b() > 0 && !wVar.g) {
            boolean z = i == 1;
            int L1 = L1(rVar, wVar, aVar.f1281b);
            if (z) {
                while (L1 > 0) {
                    int i2 = aVar.f1281b;
                    if (i2 <= 0) {
