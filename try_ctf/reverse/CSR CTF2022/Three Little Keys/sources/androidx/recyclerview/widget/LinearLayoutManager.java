...
public class LinearLayoutManager extends RecyclerView.l implements RecyclerView.v.b {
    ...
    public static class a {
        ...
        public void a() {
            this.f1282c = this.d ? this.f1280a.g() : this.f1280a.k();
        }
        ...
        public void c(View view, int i) {
            ...
            this.f1281b = i;
            if (this.d) {
                int g = (this.f1280a.g() - m) - this.f1280a.b(view);
                this.f1282c = this.f1280a.g() - g;
                if (g <= 0) {
                    return;
                }
                int c2 = this.f1282c - this.f1280a.c(view);
                int k = this.f1280a.k();
                int min2 = c2 - (Math.min(this.f1280a.e(view) - k, 0) + k);
                if (min2 >= 0) {
                    return;
                }
                min = Math.min(g, -min2) + this.f1282c;
            } else {
                int e = this.f1280a.e(view);
                int k2 = e - this.f1280a.k();
                this.f1282c = e;
                if (k2 <= 0) {
                    return;
                }
                int g2 = (this.f1280a.g() - Math.min(0, (this.f1280a.g() - m) - this.f1280a.b(view))) - (this.f1280a.c(view) + e);
                if (g2 >= 0) {
                    return;
                }
                min = this.f1282c - Math.min(k2, -g2);
            }
            this.f1282c = min;
        }
    ...
    public static class c {
        ...
        public void a(View view) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                View view3 = this.k.get(i2).f1338a;
        ...
        public View c(RecyclerView.r rVar) {
            ...
            View view2 = rVar.j(this.d, false, Long.MAX_VALUE).f1338a;
            this.d += this.e;
            return view2;
        }
    }
    ...
    public static class d implements Parcelable {
        ...
        public d(Parcel parcel) {
            ...
            this.f1291c = parcel.readInt() != 1 ? false : true;
        }

        public d(d dVar) {
            this.f1289a = dVar.f1289a;
            this.f1290b = dVar.f1290b;
            this.f1291c = dVar.f1291c;
        }
    ...
    public Parcelable A0() {
        ...
        if (y() > 0) {
            ...
            if (z) {
                View s1 = s1();
                dVar2.f1290b = this.t.g() - this.t.b(s1);
                dVar2.f1289a = R(s1);
            } else {
                View t1 = t1();
                dVar2.f1289a = R(t1);
                dVar2.f1290b = this.t.e(t1) - this.t.k();
            }
        } else {
            dVar2.f1289a = -1;
        }
    ...
    public void Z0(RecyclerView.w wVar, int[] iArr) {
        int i;
        int l = wVar.f1332a != -1 ? this.t.l() : 0;
        if (this.s.f == -1) {
            i = 0;
        } else {
            i = l;
    ...
    public final int b1(RecyclerView.w wVar) {
        ...
        f1();
        return a.h.b.b.k(wVar, this.t, j1(!this.y, true), i1(!this.y, true), this, this.y);
    }
    ...
    public final int c1(RecyclerView.w wVar) {
        ...
        f1();
        return a.h.b.b.l(wVar, this.t, j1(!this.y, true), i1(!this.y, true), this, this.y, this.w);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.l
    public void d(String str) {
        RecyclerView recyclerView;
        if (this.B != null || (recyclerView = this.f1306b) == null) {
            return;
        }
        recyclerView.i(str);
    }
    ...
    public final int d1(RecyclerView.w wVar) {
        ...
        f1();
        return a.h.b.b.m(wVar, this.t, j1(!this.y, true), i1(!this.y, true), this, this.y);
    }
    ...
    public int g1(RecyclerView.r rVar, c cVar, RecyclerView.w wVar, boolean z) {
        ...
        while (true) {
            ...
            if (!bVar.f1284b) {
                int i4 = cVar.f1287b;
                int i5 = bVar.f1283a;
                cVar.f1287b = (cVar.f * i5) + i4;
                if (!bVar.f1285c || cVar.k != null || !wVar.g) {
                    cVar.f1288c -= i5;
                    i3 -= i5;
                }
                int i6 = cVar.g;
    ...
    */
    ...
    public void v1(RecyclerView.r rVar, RecyclerView.w wVar, c cVar, b bVar) {
        ...
        Rect L = this.f1306b.L(c2);
        int z = RecyclerView.l.z(this.p, this.n, P() + O() + ((ViewGroup.MarginLayoutParams) mVar2).leftMargin + ((ViewGroup.MarginLayoutParams) mVar2).rightMargin + L.left + L.right + 0, ((ViewGroup.MarginLayoutParams) mVar2).width, e());
        int z2 = RecyclerView.l.z(this.q, this.o, N() + Q() + ((ViewGroup.MarginLayoutParams) mVar2).topMargin + ((ViewGroup.MarginLayoutParams) mVar2).bottomMargin + L.top + L.bottom + 0, ((ViewGroup.MarginLayoutParams) mVar2).height, f());
        if (T0(c2, z, z2, mVar2)) {
            c2.measure(z, z2);
        }
        bVar.f1283a = this.t.c(c2);
        if (this.r == 1) {
            if (u1()) {
                d2 = this.p - P();
                i4 = d2 - this.t.d(c2);
