...
public class ActionMenuView extends o0 implements g.b, n {
    public e A;
    public g p;
    public Context q;
    public int r;
    ...
    public class d implements g.a {
        ...
        public boolean b(g gVar, MenuItem menuItem) {
            ...
            if (eVar != null) {
                ...
                Iterator<i> it = Toolbar.this.G.f658a.iterator();
                while (true) {
                    if (!it.hasNext()) {
                        z = false;
                        break;
                    } else if (it.next().b(menuItem)) {
                        z = true;
                        break;
                    }
                }
    ...
    public boolean b(a.b.e.i.i iVar) {
    ...
    @Override // a.b.f.o0, android.view.ViewGroup
    ...
    public Menu getMenu() {
        if (this.p == null) {
            ...
            this.p = gVar;
            gVar.e = new d();
            a.b.f.d dVar = new a.b.f.d(context);
            this.t = dVar;
            dVar.l = true;
            dVar.m = true;
            m.a aVar = this.u;
            ...
            dVar.e = aVar;
            this.p.b(dVar, this.q);
            a.b.f.d dVar2 = this.t;
            dVar2.h = this;
            this.p = dVar2.f106c;
        }
        return this.p;
    ...
    public Drawable getOverflowIcon() {
        getMenu();
        a.b.f.d dVar = this.t;
        d.C0005d c0005d = dVar.i;
        if (c0005d != null) {
            return c0005d.getDrawable();
        }
        if (!dVar.k) {
            return null;
        }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (b2) {
            ...
            for (int i15 = 0; i15 < childCount; i15++) {
                ...
                if (childAt3.getVisibility() != 8 && !cVar2.f1180a) {
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt4.getVisibility() != 8 && !cVar3.f1180a) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (i17 < childCount2) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                cVar2.e = z6 && ((ActionMenuItemView) childAt).c();
                int t = t(childAt, i12, cVar2.f1180a ? 1 : i10, childMeasureSpec, paddingBottom);
                i15 = Math.max(i15, t);
                if (cVar2.d) {
                    i16++;
                }
        ...
        if (z) {
            for (int i38 = 0; i38 < childCount2; i38++) {
                ...
                if (cVar6.f) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((cVar6.f1181b * i12) + cVar6.f1182c, 1073741824), childMeasureSpec);
                }
            }
        }
        if (mode != 1073741824) {
    ...
    public void setOverflowIcon(Drawable drawable) {
        ...
        d.C0005d c0005d = dVar.i;
        if (c0005d != null) {
            c0005d.setImageDrawable(drawable);
            return;
        }
        dVar.k = true;
        dVar.j = drawable;
    ...
    public void setPresenter(a.b.f.d dVar) {
        this.t = dVar;
        dVar.h = this;
        this.p = dVar.f106c;
    }
