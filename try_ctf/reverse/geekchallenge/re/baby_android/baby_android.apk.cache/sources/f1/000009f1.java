...
public final class MaterialCalendarGridView extends GridView {
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        Long mo180getItem = adapter2.mo180getItem(adapter2.firstPositionInMonth());
        Long mo180getItem2 = adapter2.mo180getItem(adapter2.lastPositionInMonth());
        for (Pair<Long, Long> pair : dateSelector.getSelectedRanges()) {
            if (pair.first != null) {
                if (pair.second != null) {
                    long longValue = pair.first.longValue();
                    long longValue2 = pair.second.longValue();
                    if (!skipMonth(mo180getItem, mo180getItem2, Long.valueOf(longValue), Long.valueOf(longValue2))) {
                        boolean isLayoutRtl = ViewUtils.isLayoutRtl(this);
                        if (longValue < mo180getItem.longValue()) {
                        ...
                        if (longValue2 > mo180getItem2.longValue()) {
