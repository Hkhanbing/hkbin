...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void show(IBinder iBinder) {
        ...
        builder.mo188setAdapter(this.mPresenter.getAdapter(), this);
        View headerView = menuBuilder.getHeaderView();
        if (headerView != null) {
            builder.mo191setCustomTitle(headerView);
        } else {
            builder.mo193setIcon(menuBuilder.getHeaderIcon()).mo220setTitle(menuBuilder.getHeaderTitle());
        }
        builder.mo211setOnKeyListener(this);
