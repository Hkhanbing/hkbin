...
public abstract class Transition implements Cloneable {
    ...
    public Transition(Context context, AttributeSet attributeSet) {
        ...
        if (namedInt >= 0) {
            mo129setDuration(namedInt);
        }
        long namedInt2 = TypedArrayUtils.getNamedInt(obtainStyledAttributes, xmlResourceParser, "startDelay", 2, -1);
        if (namedInt2 > 0) {
            mo132setStartDelay(namedInt2);
        }
        int namedResourceId = TypedArrayUtils.getNamedResourceId(obtainStyledAttributes, xmlResourceParser, "interpolator", 0, 0);
        if (namedResourceId > 0) {
            mo130setInterpolator(AnimationUtils.loadInterpolator(context, namedResourceId));
        }
    ...
    public Transition mo129setDuration(long j) {
        this.mDuration = j;
        return this;
    }
    ...
    public Transition mo132setStartDelay(long j) {
        this.mStartDelay = j;
        return this;
    }
    ...
    public Transition mo130setInterpolator(TimeInterpolator timeInterpolator) {
    ...
    public Transition mo120addTarget(View view) {
        this.mTargets.add(view);
        return this;
    }

    /* renamed from: addTarget */
    public Transition mo119addTarget(int i) {
        if (i != 0) {
    ...
    /* renamed from: addTarget */
    public Transition mo122addTarget(String str) {
    ...
    /* renamed from: addTarget */
    public Transition mo121addTarget(Class<?> cls) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo126removeTarget(View view) {
        this.mTargets.remove(view);
        return this;
    }

    /* renamed from: removeTarget */
    public Transition mo125removeTarget(int i) {
        if (i != 0) {
    ...
    /* renamed from: removeTarget */
    public Transition mo128removeTarget(String str) {
    ...
    /* renamed from: removeTarget */
    public Transition mo127removeTarget(Class<?> cls) {
    ...
    public Transition mo118addListener(TransitionListener transitionListener) {
    ...
    public Transition mo124removeListener(TransitionListener transitionListener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo131setSceneRoot(ViewGroup viewGroup) {
