    ...
    */
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            DrawableContainerState mo24cloneConstantState = mo24cloneConstantState();
            mo24cloneConstantState.mutate();
            setConstantState(mo24cloneConstantState);
    ...
    DrawableContainerState mo24cloneConstantState() {
        return this.mDrawableContainerState;
    }
