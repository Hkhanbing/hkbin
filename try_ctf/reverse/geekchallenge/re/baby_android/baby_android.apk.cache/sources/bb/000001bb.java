...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public abstract ShowableListMenu mo47getPopup();
    ...
    protected boolean onForwardingStarted() {
        ShowableListMenu mo47getPopup = mo47getPopup();
        if (mo47getPopup == null || mo47getPopup.isShowing()) {
            return true;
        }
        mo47getPopup.show();
        return true;
    ...
    */
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        View view = this.mSrc;
        ShowableListMenu mo47getPopup = mo47getPopup();
        if (mo47getPopup == null || !mo47getPopup.isShowing() || (dropDownListView = (DropDownListView) mo47getPopup.getListView()) == null || !dropDownListView.isShown()) {
            return false;
        }
