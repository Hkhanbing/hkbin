...
public abstract class NavigationBarView extends FrameLayout {
    ...
    protected abstract NavigationBarMenuView mo241createNavigationBarMenuView(Context context);
    ...
    public NavigationBarView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        NavigationBarMenuView mo241createNavigationBarMenuView = mo241createNavigationBarMenuView(context2);
        this.menuView = mo241createNavigationBarMenuView;
        navigationBarPresenter.setMenuView(mo241createNavigationBarMenuView);
        navigationBarPresenter.setId(1);
        mo241createNavigationBarMenuView.setPresenter(navigationBarPresenter);
        navigationBarMenu.addMenuPresenter(navigationBarPresenter);
        navigationBarPresenter.initForMenu(getContext(), navigationBarMenu);
        if (obtainTintedStyledAttributes.hasValue(R.styleable.NavigationBarView_itemIconTint)) {
            mo241createNavigationBarMenuView.setIconTintList(obtainTintedStyledAttributes.getColorStateList(R.styleable.NavigationBarView_itemIconTint));
        } else {
            mo241createNavigationBarMenuView.setIconTintList(mo241createNavigationBarMenuView.createDefaultColorStateList(16842808));
        }
        ...
        if (resourceId != 0) {
            mo241createNavigationBarMenuView.setItemBackgroundRes(resourceId);
        } else {
        ...
        addView(mo241createNavigationBarMenuView);
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.navigation.NavigationBarView.SavedState.1
            ...
            public SavedState mo236createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo235createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo237newArray(int i) {
